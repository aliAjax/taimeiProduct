...
const extractTextPluginOptions = shouldUseRelativeAssetPaths
    ...
    : {};
const socketIp = require('./definePlugin');
...
module.exports = {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin(Object.assign(env.stringified,{$socketIp:socketIp.$socketIpBuild},{$host:socketIp.$hostBuild},{$dev:false})),
